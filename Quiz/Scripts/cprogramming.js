	...
	
{
	...
	options:['An Array Of Character','The Object Of Some Classes','Same As Other Primitives Data Types','Linked List Of Characters'],
	answer:0
},
...

{
	...
	options:['The Amount Of Memory To Be Alloction Should Be known beforehand','Element Of An Array can be accessed in constant time','Element Of Stored in Contiguous memory blocks','Multiple Other data structure '],
	answer:0
},

{
	q:' What does the following declaration indicate?[int x: 8;]',
	options:['x Stores value of 8','x is an 8 bit integer','Both A And B','None Of The Above'],
	answer:1
},

{
	q:'Which of the following is the proper syntax for declaring macros in C?',
	options:['#define long long ||','#define || long long','#define ||','#define long long'],
	answer:1
},

{
	q:'Which of the following is an exit controlled loop?',
	options:['While','Do-While Loop','For','None Of The Above'],
	answer:2
},
...
},
{
	...
	options:['stdio.h','stdlib.h','conio.h','None Of The Above'],
	answer:3
},
